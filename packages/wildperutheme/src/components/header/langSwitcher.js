...
const LangSwitcher = ({state, actions}) => {
  ...
  return(
      ...
      <FlagContainer>
          <a href={myLink}><ImageFlagStyles src={'https://wildperu2023.wildfreewalkingtours.com/wp-content/uploads/2022/04/US-flag.png'}/></a>
          <a href={linkSpanish}> <ImageFlagStyles src={'https://wildperu2023.wildfreewalkingtours.com/wp-content/uploads/2022/04/spanish_flag.png'}/> </a>
